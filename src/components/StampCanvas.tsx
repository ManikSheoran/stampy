...
export const StampCanvas: React.FC<StampCanvasProps> = ({ config, onOpenApiModal }) => {
  ...
  return (
    <div className="relative flex flex-col h-[560px] sm:h-[600px] lg:h-[640px] rounded-3xl editorial-card overflow-hidden">
      {/* Top Stage Toolbar */}
      <div className="flex items-center justify-between px-5 py-3.5 border-b border-[#fa812f] bg-[#fef3e2]">
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-1.5 text-xs font-semibold text-[#212529]">
            <GridFour size={15} weight="bold" className="text-[#212529]" />
            <span>Canvas</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center bg-[#fef3e2] p-1 rounded-full text-xs">
            <button
              ...
              className={`px-3 py-1 rounded-full transition-all cursor-pointer text-xs ${
                stageBg === 'envelope' ? 'bg-[#fef3e2] text-[#fa4032] font-semibold shadow-xs' : 'text-[#212529] hover:text-[#fa4032]'
              }`}
            >
              Warm
            </button>
            <button
              ...
              className={`px-3 py-1 rounded-full transition-all cursor-pointer text-xs ${
                stageBg === 'mat' ? 'bg-[#fef3e2] text-[#fa4032] font-semibold shadow-xs' : 'text-[#212529] hover:text-[#fa4032]'
              }`}
            >
              Mat
            </button>
            <button
              ...
              className={`px-3 py-1 rounded-full transition-all cursor-pointer text-xs ${
                stageBg === 'paper' ? 'bg-[#fef3e2] text-[#fa4032] font-semibold shadow-xs' : 'text-[#212529] hover:text-[#fa4032]'
              }`}
            >
              Paper
            </button>
            <button
              ...
              className={`px-3 py-1 rounded-full transition-all cursor-pointer text-xs ${
                stageBg === 'grid' ? 'bg-[#fef3e2] text-[#fa4032] font-semibold shadow-xs' : 'text-[#212529] hover:text-[#fa4032]'
              }`}
            >
              Grid
            </button>
          ...
          <div className="h-4 w-px bg-[#fa812f] mx-0.5" />

          <div className="flex items-center bg-[#fef3e2] p-0.5 rounded-full">
            <button
            ...
            <span className="text-[11px] font-medium text-[#212529] w-9 text-center">
              {Math.round(zoom * 100)}%
            </span>
            <button
      ...
      >
        ...
        {copied && (
          <div className="absolute top-4 z-20 flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-[#212529] text-[#fef3e2] text-xs font-medium shadow-md animate-in fade-in slide-in-from-top-2 duration-200">
        ...
        <p className="text-[11px] text-[#212529] mt-4 select-none font-medium">
          Click stamp to copy PNG
        </p>
      </div>

      {/* Bottom Action Bar */}
      <div className="px-5 py-3.5 border-t border-[#fa812f] bg-[#fef3e2] flex items-center justify-between">
        <div className="flex items-center gap-2">
          <button
        ...
        >
          <Sparkle size={14} weight="fill" className="text-[#fa4032]" />
